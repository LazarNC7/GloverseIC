using Gloverse.Api.Entities;
using Microsoft.EntityFrameworkCore;

namespace Gloverse.Api.Data
{
    public class GloverseDBContext:DbContext
    {
        public GloverseDBContext(DbContextOptions<GloverseDBContext> options) : base(options)
        {
